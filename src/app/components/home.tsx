...
export default function ProfileIrlPage({ pageReturn }) {
    ...
    case 1:
      content = (
        ...
        >
          ...
          <div className="flex flex-col md:grid md:py-5 py-2 md:my-auto md:grid-cols-2 gap-3 px-3 md:px-0 text-lg w-[94vw] md:w-auto h-full md:h-auto md:basis-2/3 font-mono">
            <div className="md:flex hidden p-3 items-center justify-center text-center border-1 ring-white text-white">Name: </div>
            <div className="p-3  text-white border-1 ring-white">
              Anandaffa Apriadi
            </div>
            <div className="md:flex hidden p-3 items-center justify-center border-1 ring-white text-white">Title: </div>
            <div className="p-3  text-white text-center border-1 ring-white">
              Full-stack Developer
            </div>
            <div className="md:flex hidden p-3 items-center justify-center  border-1 ring-white text-white">
              Contact:{" "}
            </div>
            <div className="p-3  text-white border-1 ring-white">
            ...
            <div className="md:flex hidden p-3 items-center justify-center text-center border-1 ring-white text-white">Status: </div>
            <div className="p-3  text-white border-1 ring-white">
              Working, Contract
            </div>
            <div className="md:flex hidden p-3  items-center justify-center border-1 ring-white text-white">
    ...
    case 2:
      content = (
        <motion.div
          ...
          className="flex flex-col p-5 gap-3 text-start text-lg md:text-2xl text-white no-scrollbar"
        >
    ...
    case 3:
      content = (
        <motion.div
          ...
          className="flex flex-col px-5 text-white text-lg gap-3 text-start no-scrollbar"
        >
          <p className="m-3">
    ...
    case 4:
      content = (
        <motion.div
          ...
          className="flex flex-col text-white text-lg px-5 gap-3 text-start no-scrollbar"
        >
          <p className="m-3">
    ...
    case 5:
      content = (
        <motion.div
          ...
          className="flex flex-col text-white text-lg gap-3 px-5 text-start no-scrollbar"
        >
          <p className="m-3">
  ...
  return (
    <>
      <div className="relative z-10 items-center flex gap-1 md:gap-6 flex-col md:flex-row justify-center w-full h-full  md:w-[75vw] md:h-[80vh]">
        <label
          onClick={() => {
            goToPage(page - 1);
          }}
          htmlFor=""
          className="hidden md:flex text-white hover:text-black hover:bg-white p-3 cursor-pointer transition-colors duration-300"
        >
          <i className="fas fa-arrow-left"></i>
        </label>

        <div className="flex flex-col items-center justify-start md:flex-row gap-2 md:gap-4 w-full h-[74vh] md:w-[75vw] md:[h-96vh]">
        ...
        {/* for mobile nav */}
        <div className="md:hidden flex flex-row justify-around w-full">
          <label
            onClick={() => {
              goToPage(page - 1);
            }}
            htmlFor=""
            className="flex justify-center items-center text-white hover:text-black hover:bg-white p-3 cursor-pointer transition-colors duration-300"
          >
            <i className="fas fa-arrow-left"></i>
          </label>
          <button
              onClick={return_}
              className="text-white text-center hover:bg-white md:0 hover:text-black transition-colors duration-300 font-mono flex justify-start items-center gap-2 p-3 md:p-2">
              Return
          </button>
          <label
            onClick={() => {
      ...
      <button
        onClick={return_}
        className="hidden text-white text-center  hover:bg-white mb-12 mt-0 md:0 hover:text-black transition-colors duration-300 font-mono md:flex justify-end items-center gap-2 p-4 md:p-2"
      >
